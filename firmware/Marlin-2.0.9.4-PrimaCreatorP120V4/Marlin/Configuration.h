...
#define STRING_CONFIG_H_AUTHOR "(Andreas Wilcox, PrimaCreator P120V4 test)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PrimaCreator P120V4"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 68.65
  #define DEFAULT_bedKi 13.17
  #define DEFAULT_bedKd 238.52
